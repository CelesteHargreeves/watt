...
(function(w) {
    ...
    dispatchEvent = function(e_name, e_data, async) {
        var ev = createCustomEvent(e_name, {
            "detail": e_data
        });
        if (!ev) {
            return;
    ...
    boomr = {
        ...
        utils: {
            ...
            setCookie: function(name, subcookies, max_age) {
                ...
                c = [nameval, "path=/", "domain=" + impl.site_domain, "SameSite=Lax", "Secure"];
                if (max_age) {
                    exp = new Date();
    ...
    dispatchEvent("onBoomerangLoaded", {
        "BOOMR": BOOMR
    }, true);
        ...
        startTimer: function(timer_name, time_value) {
            if (timer_name) {
                ...
                impl.timers[timer_name] = {
                    start: (typeof time_value === "number" ? time_value : BOOMR.now())
                };
            }
